<?php
namespace WE\Khmercourse\Controller;

/*                                                                        *
 * This script belongs to the TYPO3 Flow package "WE.Khmercourse".        *
 *                                                                        *
 *                                                                        */

use TYPO3\Flow\Annotations as Flow;
use TYPO3\Flow\Mvc\Controller\ActionController;
use WE\Khmercourse\Domain\Model\Login;
...
//    }
    ...
    public function createAction($name, $pass, $pass2) {
        ...
        $defaultRole = 'WE.Khmercourse:Visitor';
